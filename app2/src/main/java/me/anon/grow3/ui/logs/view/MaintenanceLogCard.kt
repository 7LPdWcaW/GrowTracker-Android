...
import me.anon.grow3.data.model.Maintenance
import me.anon.grow3.databinding.CardWaterLogBinding
import me.anon.grow3.view.model.Card

class MaintenanceLogCard : Card<CardWaterLogBinding>
{
	private lateinit var diary: Diary
	private lateinit var log: Maintenance

	constructor() : super(null)
	constructor(diary: Diary, log: Maintenance, title: String? = null) : super(title)
	{
		this.diary = diary
		this.log = log
	}
